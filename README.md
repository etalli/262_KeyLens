...
|---------|---------------|
| **Keyboard Heatmap** | Physical key layout colored by frequency or ergonomic strain; toggle layout template (ANSI / Ortho / JIS / Custom) and click a key to see the exact value |
