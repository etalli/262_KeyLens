...
final class L10n {
    ...
    func todaySummaryDisplay(keys: Int, mousePts: Double?) -> String {
        ...
        if let pts = mousePts {
            ...
            return ja("本日: \(keysStr) 打鍵, \(dist)", en: "Today: \(keysStr) keys, \(dist)")
        }
    ...
    var ergoSubTabTraining: String     { ja("トレーニング",      en: "Training") }
    var ergoSubTabInspector: String    { ja("インスペクタ",      en: "Inspector") }
